...
export const experienceIntro =
  "For the past few years, my goal has been to explore as much as I can while figuring out what kind of work I find most fulfilling and purposeful. I believe deeply in being a generalist, especially in an AI-driven era, and I've tried to build as much range as I can in order to understand what's happening in the world around me and where I can best contribute.\n\nI got my start building at an early-stage company, and then spent much of the last few years in venture capital and private investing. Along the way, I came to believe that being a good early- to growth-stage investor means understanding the entire arc a company travels (including what different kinds of exits look like), which is why I wanted to understand the public and capital markets, and not only the private side of the table. Most recently, I've come back around to building, now working on growth at Factory. I've loved getting to see both sides of the table, and expect to keep moving between them.";
