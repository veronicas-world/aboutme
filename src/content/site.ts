...
export const site = {
  ...
  heroInterests: {
    ...
    after:
      ". A good way to frame this vertical, I think, is that if the frontier labs are creating the next generation of generalist intelligence models, then applied AI is the successful deployment and configuration of that intelligence in practice (to them, intelligence is a commodity). As it turns out, configuration and deployment is a very hard thing to do well. I enjoy this work and find it meaningful. Beyond applied AI, I've also spent time in robotics, defense, AI infra, fintech, and a bit of consumer.",
  },
