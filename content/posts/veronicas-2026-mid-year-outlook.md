...
Another company of great interest to me (and NYC based, YAY) is [General Intuition](https://www.generalintuition.com/). Spun out of [Medal](https://medal.tv/), they are building action models and world models that are trained on billions of gameplay clips. Simply put, they fit my core conviction that compute will eventually stop being the bottleneck (shoutout AMC PBC), and proprietary data will become it. General Intuition is, in effect, a bet that a training ground no one else has (an enormous, action-labeled record of people playing) is the substrate a world model needs to learn how reality behaves.
