...
full: true
substackUrl: "https://veronicaagudelo.substack.com/p/veronicas-2026-mid-year-outlook"
cover: "https://substack-post-media.s3.amazonaws.com/public/images/7058b10f-050b-4475-b805-982447ed8d2e_700x337.jpeg"
---

![](https://substackcdn.com/image/fetch/$s_!VRNL!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F98dd6f5f-8e78-4d65-9a17-069f4381af26_1200x290.jpeg)

*James Barry, Crowning the Victors at Olympia (from “The Progress of Human Culture”)*

To state the obvious, it is **not** the middle of the year. I guess the more apt title for this would be “Veronica’s 2026 2/3 Outlook”, but that doesn’t sound great. Anyway – in [the spirit of the bulge bracket bank,](https://www.jpmorgan.com/insights/markets-and-economy/outlook/predictions-and-forecasts) I will be presenting you with a running list of what’s occupying my attention this summer (please note, this is not a predictions post), dominated by one overarching theme:
...
1. Companies are staying private longer AND 2026 has been one of the strongest IPO/M&A windows in years. [The median age of a company at IPO is around 12 years](https://www.nasdaq.com/articles/drivers-ipos-supportive-start-2026) (among the oldest cohorts since 2009) even as global private capital AUM has ballooned from under $1 trillion in 2000 to $16 trillion by 2024.

![](https://substackcdn.com/image/fetch/$s_!Rzbm!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F136a2221-c72b-43e0-9c83-180ff1d1ce8e_800x494.jpeg)

The reason for this, it seems, is that companies simply don’t need to go public for capital access anymore. And yet [upwards of $3 trillion in combined value could IPO this year alone,](https://www.nasdaq.com/articles/drivers-ipos-supportive-start-2026) with centicorns like SpaceX, OpenAI, ByteDance, Anthropic, Databricks, and Stripe all on the list. I came to the understanding that both things are true at once – private markets have gotten deep and liquid enough that going public is now a choice, which paradoxically makes the IPOs that do happen more significant.

2. On valuations of these private companies, the data is contradictory. Which is interesting.

A Q1 SaaS M&A report from Windsor Drake [found that public markets still trade at roughly a 35% premium](https://windsordrake.com/wp-content/uploads/2026/01/SaaS-MA-Report-Q1-2026.pdf) to private deals. But Goldman’s late-2025 private markets outlook [found that gap had narrowed](https://am.gs.com/en-us/advisors/insights/article/investment-outlook/private-markets-alternatives-2026) to near the long-term average. And KingsCrowd’s read on equity crowdfunding data [found the opposite in some sectors](https://kingscrowd.com/private-market-revenue-multiples-versus-public-markets-2026/) — private multiples in green energy, education, and financial services vastly exceeding public comps.
...
Conversely/of note – what is not ambiguous is where capital is going. AI infrastructure and buildout [pulled in an estimated $47 billion in private capital in 2025](https://www.linkedin.com/pulse/ai-infrastructure-capital-2026-500b-picks-and-shovels-rj-mollen-oo7te), and 2026 is on pace to exceed it. Goldman’s hyperscaler capex consensus for 2026 has climbed to $527 billion, up from $465 billion at the start of Q3 2025 earnings season. JPM’s own mid-year outlook [named AI capex the dominant growth driver](https://www.jpmorgan.com/insights/podcast-hub/making-sense/global-mid-year-outlook) for the back half of this year.

![](https://substackcdn.com/image/fetch/$s_!N8TU!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F56651bd3-8a23-47a6-8630-145aeccf5684_1856x2048.jpeg)

3. The last piece of my private market conviction comes from fixed income (oh yes, I know enough about that to actually have an opinion on it now ;D). Equities and bonds were long assumed to be negatively correlated, and that relationship was certainly taught to me, but recently, that assumption has been under strain. [Some parties expect the correlation to swing positive](https://www.oxfordeconomics.com/resource/stock-bond-correlation-will-become-positive-again-in-2026/) again in 2026 as term premia and fiscal activism reassert their influence, which would be bad news for traditional 60/40 diversification. [Others take the opposite view](https://www.blackrock.com/us/financial-professionals/insights/bonds-offer-more-diversificatio), arguing correlations are reverting slightly negative as inflation moderates.

![](https://substackcdn.com/image/fetch/$s_!X8Cg!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F46a8ef31-1944-4d10-8c9a-a83c01c9360a_800x420.png)
...
The founders of Neo will tell you that cybersecurity was built on the assumption that software behaves predictably, and moreover, that assumption breaks the moment AI agents start inheriting user identities and acting autonomously on their own initiative. Given that they [came out of stealth two days ago with $100 million in cumulative funding](https://www.neo.ai/news/neo-launches-100m), I am inclined to believe them.
...
![](https://substackcdn.com/image/fetch/$s_!cYRm!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F84f6e51f-be3b-4ed1-9dcd-727b9d2d746d_2048x1365.jpeg)

If not, no worries. Here are some highlights.

The empiricist wing of this debate is most visible in world models, and of all the neolab categories I mapped, this is the one I am most excited about. World Labs has [raised $1 billion total](https://www.artifocial.ai/blog/world-labs-marble-and-landscape-2026-mar-29), including a $200 million Autodesk strategic check in February at a $5 billion valuation, and its Marble product has been generating persistent 3D environments since November.

Its rival, AMI Labs, [closed a $1.03 billion seed in March](https://www.artifocial.ai/blog/world-labs-marble-and-landscape-2026-mar-29) at a $3.5 billion pre-money valuation, backed by an eclectic group including Bezos Expeditions, Eric Schmidt, Mark Cuban, and Tim Berners-Lee, with a JEPA-based energy model running from raw pixels on a single GPU.

The company in this category I have been watching most closely, though, is [General Intuition](https://www.generalintuition.com), which [raised a $320 million Series A in June at a $2.3 billion valuation](https://techcrunch.com/2026/06/25/general-intuitions-2-3b-bet-that-video-games-can-train-ai-agents-for-the-real-world/). Spun out of [Medal](https://medal.tv), they are building action models and world models for environments that demand deep spatial and temporal reasoning, trained on billions of gameplay clips where every frame is paired with the exact actions a player took. What makes them so compelling to me is how neatly they fit my core conviction here: compute will eventually stop being the bottleneck, and proprietary data becomes it. General Intuition is, in effect, a bet that a training ground no one else has (an enormous, action-labeled record of people playing) is exactly the substrate a world model needs to learn how reality behaves.

Others share that broader instinct about data, which is why you can find them either 1) [buying obscure book libraries for text no one else has touched](https://www.yahoo.com/news/science/articles/ai-companies-still-buying-old-154834203.html), or 2) [developing models that are incredibly data efficient](https://techcrunch.com/2026/02/16/flapping-airplanes-on-the-future-of-ai-we-want-to-try-really-radically-different-things/).
...
While at NEA, I did a lot due diligence on companies in this space, contributing to two investments — [Centralize](https://www.usecentralize.com/), an AI-driven sales relationship-intelligence platform at its Series A, and [Sol](https://www.meetsol.com/), an agentic core HR system built to replace a traditional HRIS outright, at its Seed (it had just come out of stealth).
...
Microsoft, AWS, and Google are all converging on the same pattern in their own stacks. And lucky for me and my personal interests, funding follows – [agentic AI venture funding hit $658 million across 18 deals in Q1 2026](https://newmarketpitch.com/blogs/news/agentic-ai-funding-deals), nearly triple Q4 2025. Straiker’s [$64 million Series A](https://www.straiker.ai/blog/straiker-raises-64m-series-a-to-secure-the-agentic-workforce) at the end of June, explicitly to secure the agentic workforce, is a useful companion to Neo from Theme 1.
...
Back to the public markets. Most of the defense discourse I read is America-centric, which, while it makes sense, is perhaps a mistake/oversight. [NATO’s Hague commitment has allies moving toward 5% of GDP on defense by 2035](https://www.nato.int/en/what-we-do/introduction-to-nato/defence-expenditures-and-natos-5-commitment), and in 2025 European Allies and Canada increased defense expenditure by nearly 20% year-over-year. This is not NATO’s first attempt at fixing the imbalance – the 2% guideline dates back to 2014, agreed at the Wales Summit in direct response to Russia’s annexation of Crimea.
...
The equities I am interested in that align with this view are BAE Systems, Safran, and IHI. BAE was [up 23% year-to-date](https://global.morningstar.com/en-eu/stocks/bae-systems-shares-are-up-23-2026-is-this-ftse-100-defense-stock-bu) as of mid-February, with revenue up 8%, operating profit up 9%, an order book £2.7 billion larger than in 2024, and a 10% dividend increase. And it [backed its 2026 guidance in May](https://www.morningstar.com/news/dow-jones/202605072432/bae-systems-backs-2026-guidance-citing-higher-defense-spending-opportunities-ahead) citing higher defense spending opportunities.

Across the sector, 2025 returns were dramatic: [Rheinmetall up 190%](https://www.businessinsider.com/top-defense-stocks-military-aerospace-lmt-hii-baesy-rnmby-bwxt-2025-12), Huntington Ingalls up 85%, BAE up 64%. Though, I will flag that some of the sector’s moves are definitely geopolitical-shock-driven as well – [European and Asian defense stocks all rallied 2-5% on the March US-Iran flare-up alone](https://www.cnbc.com/2026/03/02/defense-stocks-us-iran-israel-attacks-lockheed-renk-leonardo.html), and a few analysts have started warning that valuations may already be pricing in fairly optimistic growth assumptions. I still think the structural case (underspending allies, rising baseline commitments) outweighs the event-driven effects, but it is worth a quick acknowledgement.
