---
title: "The SaaSpocalypse & The Return of Hard Things"
subtitle: "The SaaSpocalypse might actually be very good for everyone (including software)"
date: "2026-04-02"
category: "emerging-tech"
substackUrl: "https://veronicaagudelo.substack.com/p/the-saaspocalypse-and-the-return"
full: true
---

---

![](https://substackcdn.com/image/fetch/$s_!YKc7!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd093f59a-8156-432f-8c7d-2a1aa25b246c_1144x1136.png)

*Quick aside — I was so very delighted to see [this](https://www.linkedin.com/posts/peterjameswalker_bad-advice-dont-build-startups-that-touch-share-7464370357064523776-fhdb/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADeKydYB-g2ZOaj76Y8yOCCzM-ZgDdLZ8nQ) post (which also where I got the chart above) from the magnificent Peter Walker (highly recommend a follow), which is a pretty great validation of what I argue below ;)*
...
The overly-simplified explanation for this selling-spree was that investors suddenly realized that if one AI agent can do the work of ten humans, maybe you don’t need fifty Salesforce licenses anymore. The articles that followed the events in the market [explained](https://mynextdeveloper.com/blogs/anthropics-saaspocalypse-the-day-ai-started-doing-the-work/) that this was “the day AI started doing the work,” and that per‑seat pricing (which is essentially the crown jewel of SaaS economics) [had finally met its match](https://markets.financialcontent.com/stocks/article/marketminute-2026-3-30-the-saaspocalypse-of-2026-how-generative-ai-broke-the-software-growth-engine).
...
The incumbents, for obvious reasons, do not love this story. Marc Benioff went on [what can only be described as a charm offensive](https://techcrunch.com/2026/02/25/salesforce-ceo-marc-benioff-this-isnt-our-first-saaspocalypse/), insisting that this wasn’t Salesforce’s “first SaaSpocalypse,” comparing it to the shift from on‑prem to cloud and positioning Salesforce as an “operating system for AI agents,” not collateral damage. Salesforce [even rolled out its own “agentic work units” pricing concept](https://www.ft.com/content/b74b8227-d7cb-4976-ba95-a3a27b79cbdd?syn-25a6b1a6=1), (which seems like a spiritual successor to the per‑seat license?) to try to push the idea that software can be a sort of collaborator instead of a static tool.
...
Here is where my observations get a little more interesting. Early-stage investors are noticing this “ease of building” phenomenon. And several analyses [point to a sharp bifurcation](https://www.trendingtopics.eu/guest-post-t-rowe-price-saas-ai/): a handful of AI‑native or infrastructure software names still command rich multiples, while the long tail of traditional SaaS names trade down and struggle to raise. [Carta](https://carta.com/data/saas-industry-spotlight-Q3-2025/) has documented that software rounds are smaller, more selective, and heavily skewed toward companies that either have real traction or are embedded deep in the AI stack.
...
## W**hat Early-Stage Money Was Actually Paying For**
...
## T**he Return of Hard, Capital-Intensive Things**

If you look at where new funds and “hot theses” are clustering, [you will see a pattern of concentration](https://techcrunch.com/2025/12/26/whats-ahead-for-startups-and-vcs-in-2026-investors-weigh-in/) across climate, energy, robotics, new materials, AI hardware, and biotech platforms. Essentially, the stuff that can’t be spun up with the help of Codex in a weekend, no matter how good your prompts are.

[Climate and energy are a good example](https://entrepreneurloop.com/ai-climate-tech-funding-largest-rounds-2025/). Recent climate tech reports [show tens of billions flowing](https://trellis.net/article/climate-tech-investment-2026-ai-wave/) into grid infrastructure, storage, industrial decarbonization, and “hard” energy projects. These are exactly the kinds of companies that need massive upfront capex for pilots, plants, and physical assets, face multi‑year regulatory and engineering risk, and can’t be bootstrapped with $10k and a Notion page.
...
## W**hat Survives (And Why This Is Net-Positive)**
