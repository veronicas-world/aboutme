---
title: "Can We Study the Most Popular Consumer Apps like Social Movements?"
subtitle: "A working theory..."
date: "2026-05-03"
category: "emerging-tech"
substackUrl: "https://veronicaagudelo.substack.com/p/can-we-study-the-most-popular-consumer"
full: true
---

![](https://substackcdn.com/image/fetch/$s_!hpo9!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F13161f7d-3645-4fd3-b753-30842249d8f7_2048x1285.jpeg)
...
Political scientists have a term for this kind of reconfiguration that you’ve probably heard of — social movements. These researchers have spent decades trying to quantify how movements start and, perhaps more importantly, why some of them win. One of the most interesting people doing this is [Erica Chenoweth](https://www.belfercenter.org/person/erica-chenoweth) at the Harvard Kennedy School (HKS). [They have catalogued campaigns over the last century](https://ash.harvard.edu/programs/nonviolent-and-violent-campaigns-and-outcomes-data-project/), and in one particularly famous slice of research, they found that nonviolent campaigns which [mobilize sustained participation from roughly a few percent of the population](https://www.bbc.com/future/article/20190513-it-only-takes-35-of-people-to-change-the-world) (around 3.5%) almost always succeed in their main demands.

I’m not interested in smuggling that number straight into tech and declaring that every app only needs 3.5% of Gen Z to become revolutionary. Chenoweth is explicit that it’s an empirical pattern in one dataset, not a law of history, and [later work has pushed back on people treating it like numerology](https://commonslibrary.org/chenoweth-3-5percent-rule/). What I am interested in is the shape of the claim — that perhaps beyond some threshold, a small, committed minority can tilt the equilibrium for everyone else.
...
1. Population: the group whose behavior matters (a country, a city, a specific constituency).
2. Active participants: people who are actually doing the thing — marching, striking, organizing.
3. Committed minority: the subset that shows up over and over, often at some personal cost.
4. Thresholds/critical mass: participation levels at which outcomes become much more likely to flip.
5. Network position: the fact that activists, brokers, and opinion leaders matter more than a random person pulled from the phone book.

In movement datasets like the [Nonviolent and Violent Campaigns and Outcomes Project (NAVCO)](https://ash.harvard.edu/programs/nonviolent-and-violent-campaigns-and-outcomes-data-project/), those show up as variables you can code and correlate with success rates. My attempt in the rest of this essay is to sketch analogous variables for social apps (populations, active users, committed cores, and thresholds) and see whether they line up with the history of some of the most popular consumer apps of our time — Facebook, TikTok, and BeReal.
...
![](https://substackcdn.com/image/fetch/$s_!yGsA!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6ba33c56-75fa-46eb-b00d-8fe216185705_1228x538.png)
...
1. Facebook [launched at Harvard in February 2004](https://en.wikipedia.org/wiki/History_of_Facebook) as a Harvard‑only site.
2. Within the first 24 hours, roughly 1,200 students had signed up.
3. Within a month, [more than half of Harvard’s undergraduate population](https://www.thecrimson.com/article/2014/2/4/facebook-ten-years-feature-1/) was registered.
4. By the end of 2004, still operating as a gated college network, it had [crossed a million registered users](https://www.weforum.org/stories/2019/02/how-facebook-grew-from-0-to-2-3-billion-users-in-15-years/).
5. By September 2005 (eighteen months after launch) [85% of students at supported colleges had a profile, 60% were logging in daily, and 93%](https://techcrunch.com/2005/09/07/85-of-college-students-use-facebook/) at least once a month.
...
1. The population is a few thousand undergrads living in dense, overlapping social proximity.
2. Active participant**s** are the students logging in daily, checking profiles, updating relationship statuses, narrating their lives in real time.
3. The committed minority (the equivalent of Chenoweth’s organizers and activists) are the people uploading photos obsessively, running groups, building the social graph aggressively enough that opting out started to carry a real cost.
...
![](https://substackcdn.com/image/fetch/$s_!1_Mr!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff018698d-798b-403f-b1be-0d02d9673188_2510x1162.png)

The download curve tells the first part of the story. Downloads peaked in August 2022 and were already visibly declining by September, and yet [DST Global led the $60M Series B at a $630M valuation in October 2022](https://techcrunch.com/2022/10/20/sources-bereal-raised-60m-in-its-series-b-earlier-this-year-now-has-20m-daus/), after the leading indicator had already turned.

By August 2022, [BeReal had 73.5 million monthly active users](https://www.businessofapps.com/data/bereal-statistics/). Daily actives [hit 20 million in October 2022](https://petapixel.com/2023/02/22/bereal-may-be-on-the-out-users-have-nearly-halved-since-peak/), the same month the Series B closed. By February 2023, just four months later, DAUs had dropped 48%, from 20 million to 10.4 million. By March 2023, [DAUs were at 6 million](https://appicsoftwares.com/blog/bereal-statistics/), a 70% collapse from peak in five months. By the end of 2024, monthly actives had fallen 78% from their high, [settling around 16 million](https://www.businessofapps.com/data/bereal-statistics/).

![](https://substackcdn.com/image/fetch/$s_!qYAy!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F340efe1d-acb0-44b6-acf7-5704795ae7f6_2504x1124.png)

And through all of it — through the cultural explosion, the tier-one fundraises (a16z + DST), and App Store dominance, [BeReal generated exactly zero dollars in revenue](https://sifted.eu/articles/voodoo-bereal-2024-results). At the time of the Series B, the company had explicitly stated it had no plans to monetize. At acquisition in June 2024, it was still at zero revenue, burning roughly $3 million a month. When [Voodoo bought it for a headline €500M (~$537M)](https://sifted.eu/articles/bereal-acquired-500m-news), two-thirds of that price was structured as contingent earnouts tied to future performance targets for a product in freefall. The guaranteed cash component was closer to €166 million on [$91.8 million raised](https://research.contrary.com/company/bereal).
...
![](https://substackcdn.com/image/fetch/$s_!iSd0!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5a5eb402-9c4b-4d52-a8e8-4890db611c3a_2502x1148.png)
...
![](https://substackcdn.com/image/fetch/$s_!5z1H!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe2d789b1-7039-4b19-94b5-4079ca2f509a_2514x1146.png)
...
1. Local adoption rates over time in specific communities (campuses, cities, subcultures rather than global MAU).
2. Behavior depth (posting vs. lurking, invite rates, cross-platform presence).
3. Network roles (who are the creators, connectors, and moderators, and how many of them are there relative to passive users).
4. Outcomes (did the app become default infrastructure, stay niche, or fade like BeReal?).
