...
*A note before I start – most of what follows is about taking things out. The last few weeks of work on Whel have included a lot of rebuilding the machinery/engine that scores data. Oops. This period of “undoing” was also, I think, the most useful stretch of work I’ve done on this project. So this is the post where I explain why the model is now a different one than it was earlier in June.*
...
Almost every change above trades a more flattering surface for a more defensible one — fewer counted signals but a cleaner unit; one fewer arm but a better account of what cross-condition data is; a deleted grade but no more circular self-validation; a model upgrade paired with a more careful statement of its limits.
